...
export const CLASSES_STATE_VARIANTS: States = {
  ...
  textSecondary: `bg-transparent text-secondary uppercase tracking-wider border-none hover:text-primary transition-all duration-500 ease-in-out`,
  solidSecondary: `bg-secondary border-secondary-dark text-gray-50 hover:bg-primary transition-all duration-500 ease-in-out`,
